...
public class Partie
{
	...
	public void menu()
	{
		...
		if(choixMenu == 1){
			...
			System.out.println("Saisir 3 : Charger Partie");
			this.nouvellepartie(j1,j2);
			...
			if(choixMenu == 2){
				try{
				this.sauvegarder("/Users/amyeben/Desktop/sauve.txt");
	...
	public Joueur alternerJoueur(int tours, Joueur j1, Joueur j2) {
		if(tours%2 == 0)//Paire
			{System.out.println("Pour continuer la partie appuie sur 6 et Entrer ;)");
			return j2;}
		return j1;
	}
	...
	public void nouvellepartie(Joueur j1, Joueur j2)
	{
	...
	public void tourDeJeu(Joueur j, int tours)
	{
		...
		System.out.println(j.toString()+"\n"+j.getPrenom() + ", quelle pièce voulez-vous déplacer? (saisir coordonnées)");
		...
		try {
			...
			System.out.println("La saisie n'est pas conforme, il faut qu'elle soit de forme \"B3\", \n par exemple pour B la colonne et 3 la ligne partant du bas. ");
		}
