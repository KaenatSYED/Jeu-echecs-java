...
public class LancerPartie {
	    ...
	    public static void main(String[] args) {
	    	...
	    	System.out.println("\n");
	 		...
	 		Tour tn1 = new Tour(7,0,1);
	 		Cavalier cn1 = new Cavalier(7,1,1);
	 		Fou fn1 = new Fou(7,2,1);
	 		Reine ren1 = new Reine(7,3,1);
	 		Roi ron1 = new Roi(7,4,1);
	 		Fou fn2 = new Fou(7,5,1);
	 		Cavalier cn2 = new Cavalier(7,6,1);
	 		Tour tn2 = new Tour(7,7,1);
			...
			Joueur joueur1 = new Joueur("Amy",1);
			Joueur joueur2 = new Joueur("Kaenat",0);
